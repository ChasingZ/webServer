...
void help(int fd = 0, string str="");//有默认值 
...
unordered_map<string,string> commandMap = {
    ...
    {"groupchat","加入群组, 格式 groupchat:groupid:message"},
    {"loginout","注销, 格式loginout"}
};
//注册系统支持的客户端命令处理  <int,string> socketfd 数据
...
void mainMenu(int clientfd)
{
    ...
    {
        cin.getline(buffer,1024);//buffer就是按格式输入的
...
//"help" command handler;
void help(int fd, string str)//有默认值
{
